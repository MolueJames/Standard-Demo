...
class SKImageButton: SKButton {
    ...
    override init(frame: CGRect) {
        ...
        setup(imageName)
        showFrame = CGRect(x: marginX, y: marginY, width: sksize.width, height: sksize.height)
        hideFrame = CGRect(x: marginX, y: -marginY, width: sksize.width, height: sksize.height)
    }
}

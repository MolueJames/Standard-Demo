...
extension String {
    ...
    @available(*, deprecated, message: "This extension is deprecated, please use .count instead.")
	...
	@available(*, deprecated, message: "Please use string[safe: i] instead.")
	...
	@available(*, deprecated, message: "Please use string[safe: start..<end] instead.")
	...
	@available(*, deprecated, message: "Please use string.index(of: Character) or string.range(of: StringProtocol) instead.")
	...
	@available(*, deprecated, message: "Please use string.split(separator: Character) instead.")

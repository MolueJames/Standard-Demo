...
public extension String {
    ...
    var isNumeric: Bool {
        ...
        let isDecimal = decimal != nil
        return isDecimal && scanner.isAtEnd
    }
...
public extension String {
    ...
    func separateTypeName() -> (module: String?,file: String?) {
...
public extension String {
    ...
    func estimateFrame(with fontSize: CGFloat, width: CGFloat, lineSpacing: CGFloat) -> CGRect {
    ...
    func estimateHeight(with fontSize: CGFloat, width: CGFloat, lineSpacing: CGFloat = 5) -> CGFloat {

...
public extension Color {
	...
	convenience init(red: Int, green: Int, blue: Int, transparency: CGFloat = 1) {
		guard red >= 0 && red <= 255 else { fatalError("red value is invalid") }
		guard green >= 0 && green <= 255 else { fatalError("green value is invalid") }
		guard blue >= 0 && blue <= 255 else { fatalError("blue value is invalid") }

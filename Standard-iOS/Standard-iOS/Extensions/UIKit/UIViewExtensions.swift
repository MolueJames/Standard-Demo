...
public extension UIView {
    ...
    func doBespreadOn(_ childView: UIView) {
        guard childView.superview == nil else {
            Logger.surface.error("the child view alreadly has superview")
            return
        }
